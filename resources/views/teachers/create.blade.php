...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-2xl font-black text-slate-800">Add New Teacher</h1>
    ...
    <form action="{{ route('teachers.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 overflow-hidden">
            ...
            <div class="px-8 pb-8 pt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="file" name="photo" accept="image/*" 
                           class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-transparent dark:border-slate-600 rounded-2xl text-sm font-bold text-slate-700 dark:text-slate-100 transition-all file:mr-4 file:py-1.5 file:px-3 file:rounded-lg file:border file:border-slate-300 dark:file:border-slate-600 file:text-sm file:text-slate-600 dark:file:text-slate-300 file:bg-transparent file:cursor-pointer hover:file:bg-slate-50 dark:hover:file:bg-slate-700">
                ...
                <div class="space-y-2 md:col-span-2">
                    ...
                    <textarea name="address" rows="3" placeholder="Residential address..." 
                              class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-transparent dark:border-slate-600 rounded-2xl text-sm font-bold text-slate-700 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 transition-all">{{ old('address') }}</textarea>
            ...
            <div class="px-8 py-6 bg-slate-50/50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-700 flex items-center justify-end gap-3">
                <button type="reset" class="bg-transparent border border-slate-600 text-slate-300 hover:bg-slate-700 rounded-lg px-4 py-2 text-sm font-medium transition-all">
                    Reset Form
                </button>
