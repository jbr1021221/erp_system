...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-slate-400 text-sm font-medium leading-5 text-slate-800 focus:outline-none focus:border-slate-700 transition duration-150 ease-in-out'
