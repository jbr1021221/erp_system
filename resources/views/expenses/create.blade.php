...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-slate-50 shadow-sm rounded-xl border border-slate-200 overflow-hidden">
            <form action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-1">
                            <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="e.g., Office Supplies" required class="shadow-sm focus:ring-slate-500 focus:border-slate-500 block w-full sm:text-sm border-slate-300 rounded-md">
                        </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                            <input type="text" name="reference_no" id="reference_no" value="{{ old('reference_no') }}" placeholder="Auto-generated if empty" class="shadow-sm focus:ring-slate-500 focus:border-slate-500 block w-full sm:text-sm border-slate-300 rounded-md">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="amount" id="amount" value="{{ old('amount') }}" step="0.01" required class="focus:ring-slate-500 focus:border-slate-500 block w-full pl-7 pr-12 sm:text-sm border-slate-300 rounded-md" placeholder="0.00">
                        </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="date" name="expense_date" id="expense_date" value="{{ old('expense_date', date('Y-m-d')) }}" required class="shadow-sm focus:ring-slate-500 focus:border-slate-500 block w-full sm:text-sm border-slate-300 rounded-md">
                        </div>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            ...
                            <p class="mt-1 text-xs text-slate-500">Allowed types: jpeg, png, pdf. Max 2MB.</p>
                        </div>
