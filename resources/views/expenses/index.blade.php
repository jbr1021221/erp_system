            ...
            <form action="{{ route('expenses.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input type="text" name="search" id="search" class="focus:ring-slate-500 focus:border-slate-500 block w-full pl-10 sm:text-sm border-slate-300 rounded-xl py-2.5" placeholder="Search by reference or title..." value="{{ request('search') }}" style="background-color: rgb(var(--bg-elevated)); color: rgb(var(--text-primary));">
                    </div>
                </div>
                
                 <div>
                    <select name="category_id" class="block w-full pl-3 pr-10 py-2.5 text-lg border-slate-300 focus:outline-none focus:ring-slate-500 focus:border-slate-500 sm:text-sm rounded-xl" style="background-color: rgb(var(--bg-elevated)); color: rgb(var(--text-primary));">
                ...
                <div>
                    <select name="status" class="block w-full pl-3 pr-10 py-2.5 text-lg border-slate-300 focus:outline-none focus:ring-slate-500 focus:border-slate-500 sm:text-sm rounded-xl" style="background-color: rgb(var(--bg-elevated)); color: rgb(var(--text-primary));">
                ...
                <div class="md:col-span-4 flex justify-end">
                    <a href="{{ route('expenses.index') }}" class="mr-3 inline-flex items-center px-4 py-2 shadow-sm text-sm font-medium rounded-xl transition-colors" style="border: 1px solid rgb(var(--border-primary)); background-color: rgb(var(--bg-elevated)); color: rgb(var(--text-secondary));" onmouseover="this.style.backgroundColor='rgb(var(--bg-secondary))';" onmouseout="this.style.backgroundColor='rgb(var(--bg-elevated));';">
                        Reset
                    </a>
