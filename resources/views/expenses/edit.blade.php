...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="md:flex md:items-center md:justify-between mb-8">
            <div class="flex-1 min-w-0">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Update expense details. Only pending expenses can be edited.
                </p>
            </div>
        ...
        <div class="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden">
            <form action="{{ route('expenses.update', $expense) }}" method="POST" enctype="multipart/form-data" class="space-y-6 p-8">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-1">
                            <input type="text" name="title" id="title" value="{{ old('title', $expense->title) }}" required class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                            <input type="text" name="reference_no" id="reference_no" value="{{ old('reference_no', $expense->reference_no) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="amount" id="amount" value="{{ old('amount', $expense->amount) }}" step="0.01" required class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md">
                        </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="date" name="expense_date" id="expense_date" value="{{ old('expense_date', $expense->expense_date->format('Y-m-d')) }}" required class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <textarea id="description" name="description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-md">{{ old('description', $expense->description) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        @if($expense->attachment)
                            <div class="mb-2">
                                <a href="{{ Storage::url($expense->attachment) }}" target="_blank" class="text-sm text-indigo-600 hover:text-indigo-900 underline">View current attachment</a>
                            </div>
                        @endif
                        <div class="mt-1">
                            ...
                            <p class="mt-1 text-xs text-gray-500">Upload to replace current attachment. Allowed types: jpeg, png, pdf.</p>
                        </div>
