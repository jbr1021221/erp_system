...
@section('content')
    ...
    <div>
        <h1 class="text-xl font-semibold text-slate-800 dark:text-slate-100">User Management
                </h1>
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Manage system users, roles, and access permissions.
                </p>
    </div>
            @can('user-create')
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-slate-100">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">User Info</th>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Joined Date</th>
                    ...
                    <tbody class="bg-slate-50 divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-slate-100 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        ...
                                        @else
                                            <div class="h-10 w-10 rounded-full bg-slate-200 flex items-center justify-center text-slate-800 font-bold">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $user->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-slate-200 text-slate-800' }}">
                                    {{ ucfirst($user->status) }}
                                </span>
                            </td>
