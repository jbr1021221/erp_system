...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mt-6 flex justify-between items-center gap-4 print:hidden">
        ...
        <div class="flex gap-3">
            ...
            <button onclick="downloadPDF()" class="inline-flex items-center px-6 py-2 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-emerald-600 hover:bg-emerald-700 transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
